function [NERC_Region_Code,NERC_Region_Long_Name] = NERC_Region_Information_From_NERC_Region_Code(NERC_Region_Short_Name)
    ...
    if size(NERC_Region_Short_Name,2) == 5
       if NERC_Region_Short_Name == 'ERCOT'; NERC_Region_Code = 9; NERC_Region_Long_Name = 'Texas Reliability Entity'; end
    end
end