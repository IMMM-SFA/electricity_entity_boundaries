...
function Plot_Entity_Maps_All_Years(output_summary,run_manual_corrections,year,number_of_utilities_png,number_of_nerc_regions_png,primary_nerc_region_png,number_of_ba_png,primary_ba_png,lat_min,lat_max,lon_min,lon_max)
    ...
    if run_manual_corrections == 0
       load([output_summary,'.mat']);
    elseif run_manual_corrections == 1
       load([output_summary,'_with_Manual_Corrections.mat']);
    end
